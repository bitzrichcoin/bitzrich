...
static const int64 MAX_MONEY = 85000000 * COIN; // BitzRichCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1) / 250; // BitzRichCoin: Priority cutoff is 2 BitzRichCoin day / 250 bytes.
    }
